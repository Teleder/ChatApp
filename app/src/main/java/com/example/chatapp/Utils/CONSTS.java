...
public class CONSTS {
    ...
    public final static String EMOJI = "EMOJI";    public final static String NEW_GROUP = "NEW_GROUP";
    ...
    public static final int TYPE_SENT_AUDIO = 4;
    public static final int TYPE_RECEIVED_AUDIO = 5;
    public static final int TYPE_SENT_VIDEO = 6;
    public static final int TYPE_RECEIVED_VIDEO = 7;
    public static final int TYPE_SENT_STICKER = 8;
    public static final int TYPE_RECEIVED_STICKER = 9;
    public static final int TYPE_SENT_FILE = 10;
    public static final int TYPE_RECEIVED_FILE = 11;
}
